...
def show_image_callback(img_data, xxx_todo_changeme):
    ...
    try:
        ...
        cv_image = cv_image[0:480, 56:696]
        cv_image = cv2.copyMakeBorder(cv_image, 80, 80, 0, 0, cv2.BORDER_CONSTANT, value=[0, 0, 0])
        #cv_image = cv_image[32:448, 168:584]
    ...
    cv2.circle(cv_image, (int(width/2), int(heigth/2)), 3, (0,255,0), 3)
